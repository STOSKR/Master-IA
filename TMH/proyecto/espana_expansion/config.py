...
PENALIZACION_FUERA_HORARIO = 500 
PENALIZACION_EXCESO_TIEMPO = 100   # Reducido de 100 → 50 (más gradual)
PENALIZACION_LIMITE_CIUDAD = 100
PENALIZACION_RESTAURANTES_CONSECUTIVOS = 300  # Reducido de 300 → 200
FACTOR_PENALIZACION_TIEMPO = 3
PENALIZACION_FUERA_HORARIO_APERTURA = 5000
PENALIZACION_EXCESO_PRESUPUESTO = 10
PENALIZACION_CAMBIO_CIUDAD_INNECESARIO = 300  
PENALIZACION_DISTANCIA_POR_KM = 0.3
