...
TIEMPO_CENA_MIN = 90
VELOCIDAD_MEDIA = 15  # km/h (mix caminar + metro/bus: más realista que 5 o 30)

POBLACION_DEFAULT = 10000
GENERACIONES_DEFAULT = 400
PROB_CRUCE = 0.8
PROB_MUTACION = 0.35  # Aumentado de 0.2 → 0.35 para más diversidad
PROBABILIDAD_CRUCE = 0.8  
PROBABILIDAD_MUTACION = 0.35  # Aumentado de 0.2 → 0.35
ELITISMO_PORCENTAJE = 0.15  # Reducido de 0.20 → 0.15 (menos elitismo = más diversidad)
...
PENALIZACION_FUERA_HORARIO = 150  # Reducido de 200 → 150
...
PENALIZACION_FUERA_HORARIO_APERTURA = 300  # Significativa pero no catastrófica
