...
python ejecutar_config_individual.py --nombre "Elit05_4h" --poblacion 1000 --elitismo 0.05 --horas 4 --guardar-json --guardar-grafica --output-dir resultados_elitismo
