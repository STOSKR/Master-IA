...
python ejecutar_config_individual.py --nombre "Exploracion_5000_8h" --poblacion 5000 --elitismo 0.10 --horas 8 --guardar-json --guardar-grafica --output-dir resultados_8h
