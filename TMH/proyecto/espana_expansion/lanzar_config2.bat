...
python ejecutar_config_individual.py --nombre "Poblacion_1500_8h" --poblacion 1500 --elitismo 0.15 --horas 8 --guardar-json --guardar-grafica --dias 20 --lugares-por-dia 12 --output-dir resultados_8h
