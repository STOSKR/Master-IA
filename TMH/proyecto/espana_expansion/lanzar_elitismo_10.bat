...
python ejecutar_config_individual.py --nombre "Elit10_4h" --poblacion 1000 --elitismo 0.10 --horas 4 --guardar-json --guardar-grafica --output-dir resultados_elitismo
