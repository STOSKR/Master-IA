...
python ejecutar_config_individual.py --nombre "Elit15_4h" --poblacion 1000 --elitismo 0.15 --horas 4 --guardar-json --guardar-grafica --output-dir resultados_elitismo
