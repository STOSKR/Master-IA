...
notebook_path = "P2_NLLB_Finetuning_RU-ZH.ipynb"
output_path = f"P2_NLLB_Finetuning_RU-ZH_output_{datetime.now().strftime('%Y%m%d_%H%M%S')}.ipynb"
...
try:
    ...
    error_path = f"P2_NLLB_Finetuning_RU-ZH_error_{datetime.now().strftime('%Y%m%d_%H%M%S')}.ipynb"
