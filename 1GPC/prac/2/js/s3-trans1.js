...
function loadScene() {
  ...
  visagra = new THREE.Mesh(new THREE.BoxGeometry(0.05, 0.05, 32), new THREE.MeshNormalMaterial());
  caja1.add(visagra);
  visagra.position.x = 2.5;
  visagra.position.y = 0.5;
